...
class Sender(object):
    ...
    def send(self, message, to='', reply_on=None, reply_to=None, expire=None):
        ...
        if isinstance(message, JsonMessage):
            props = self.__default_properties(message, reply_on, expiration, reply_to)
    ...
    def __default_properties(self, message, correlation_id=None, expiration=None, reply_to=None):
