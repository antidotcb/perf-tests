...
class Orchestrator(cmd.Cmd):
    ...
    def do_mt4_clean(self, *args):
        self._sender.send(ExecuteRequest(script='C:\\work\\perf-tests\\common\\scenario_scripts\\mt4_clean.bat'))

    def do_mt4_clean_logs(self, *args):
        self._sender.send(ExecuteRequest(script='C:\\work\\perf-tests\\common\\scenario_scripts\\mt4_clean_logs.bat'))
